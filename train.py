...
def setup_training_loop_kwargs(
    ...
    if cfg == "cifar":
        ...
        args.D_kwargs.architecture = (
            "orig"  # disable residual skip connections
        )
...
@click.option(
    "--snap",
    help="Snapshot interval [default: 50 ticks]",
    type=int,
    metavar="INT",
)
@click.option(
...
@click.option(
    "--nhwc",
    help="Use NHWC memory format with FP16",
    type=bool,
    metavar="BOOL",
)
@click.option(
